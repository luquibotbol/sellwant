 ...
 *
 * WORDING RULE: these states record what someone SAID, never what SellWant
 ...
 * constraint but is dead -- D2 decided SellWant never holds the ticket, so
  ...
  pending_payment: {
    buyer: {
      ...
      body:
        ...
        'SellWant never sees the payment — we only record what you tell us.',
      waiting: false,
      showPayment: true,
